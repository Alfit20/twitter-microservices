package kg.alfit.kafka.elastic.service.consumer.impl;

import com.microservices.demo.kafka.avro.model.TwitterAvroModel;
import kg.alfit.config.KafkaConfigData;
import kg.alfit.config.KafkaConsumerConfigData;
...
import kg.alfit.kafka.elastic.service.consumer.KafkaConsumer;
import kg.alfit.kafka.elastic.service.transformer.AvroToElasticModelTransformer;
...
public class TwitterKafkaConsumer implements KafkaConsumer<Long, TwitterAvroModel> {
    ...
    public void receive(@Payload List<TwitterAvroModel> messages,
        ...
        List<IndexedObjectInformation> documentsId = elasticIndexClient.save(elasticModels);
        documentsId.forEach(documentId -> log.info("Documents saved to elasticsearch with ids {}", documentId.getId()));
